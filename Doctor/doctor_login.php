 ...
 <h1  class=" text-center font-weight-bold text-white ">Doctor Login</h1>
  ...
  <form class="modal-content animate" action="doctor_login.php" method="post">
      ...
      <label for="email"><b> Email</b></label>
          <p><input class="w3-input w3-border" type="text" placeholder="Enter e-mail"  name="email" pattern="[^ @]*@[^ @]*" style="width:100%" required></p>
         <label for="pswd"><b>Password</b></label>
     <p> <input class="w3-input w3-border" type="password" minlength="6" maxlength="10" placeholder="Enter Password" name="pswd" required></p>
