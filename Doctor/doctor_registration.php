...
<label for="email"><b>Email Address:</b></label><br /><br /><input type="email" placeholder="Enter Your Email Address"class="form-control" size="50" pattern="[^ @]*@[^ @]*" name="email" required><br /><br />
