    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav navbar-right">
        ...
        <li class="dropdown">
          ...
          <ul class="dropdown-menu"> 
     <li>   <a href='location map/mymensingh.html'>Chamarajanagar</a></li>
     <li>   <a href='location map/rajshahi.html'>Tumkur</a></li>
     <li>   <a href='location map/Mandya.html'>Mandya</a></li>
     <li>   <a href='location map/Mysore.html'>Mysore</a></li>
        </ul>
        </li>
  ...
  <div class="w3-container w3-content w3-padding-64" style="max-width:800px"  id="contact">
    ...
    <div class="w3-row w3-padding-32">
      <div class="w3-col m6 w3-large w3-margin-bottom">
        <i class="fa fa-map-marker" style="width:30px"></i>Mysore,karnataka,India<br>
        <i class="fa fa-phone" style="width:30px"></i> Phone: +91987654321<br>
...
<footer class="text-center">
  ...
  <p>Copyright<a href="http://labaidgroup.com/specialized/doctor" data-toggle="tooltip" title="e-Healthcare">@Mrit</a></p> 
</footer>
<script>
