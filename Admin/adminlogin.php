...
?>
 ...
 <h1  class=" text-center font-weight-bold text-white ">Admin Login</h1>
  ...
  <form class="modal-content animate" action="adminlogin.php" method="post">
      ...
      <input type="email" class="w3-input w3-border" placeholder="Enter e-mail" name="email" pattern="[^ @]*@[^ @]*" minlength="20" maxlength="50" style="width:100%"  required>

      <label for="pswd"><b>Password</b></label>
      <input type="password" class="w3-input w3-border" minlength="6" maxlength="10" placeholder="Enter Password" name="admin_pswd" style="width:100%" required>
