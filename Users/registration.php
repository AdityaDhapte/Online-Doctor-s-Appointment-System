...
<br /><br />
<input type="text"style="font-size:16px" pattern="[^ @]*@[^ @]*" minlength="20" maxlength="30" placeholder="Enter Your Email Address"name="email"required><br /><br />
<label for="contact"style="font-size:16px"><i class="fa fa-address-card-o"></i>   Contact Number: *</label>
<br /><br />
<input type="contact"style="font-size:16px" placeholder="Enter Your Contact Number"name="contact" minlength="10" maxlength="10" pattern="[0-9]{10}" required><br /><br />
...
<label for="pswd" style="font-size:16px"><i class="fa fa-key icon"></i>  Create New Password: *</label><br /><br /><input type = "password"placeholder="Create Your password" minlength="8" maxlength="20" maxname="pswd"required>  <p style="font-size:16px"> password should be more than 8 characters long </p>
